...
public class Exam0480 {
  public static void main(String[] args) {
    ...
    int menu4 = LOGOUT | GENERAL | ADMIN; // 로그아웃 되었든, 일반으로 로그인 되었든,
    //관리자로 로그인 되었든 모두 접근 가능한 메뉴
    ...
    // GENERAL 비트(오른쪽에서 첫 번째 비트)가 1인지 검사한다는 뜻이다.
    // 
    ...
    // 그 값을 2진수로 보았을 때 ADMIN 비트가 1이라는 것이다.
    // 
  }
}
