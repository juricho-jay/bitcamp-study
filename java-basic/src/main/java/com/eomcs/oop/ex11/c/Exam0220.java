...
class B2 {
  ...
  class X {
    ...
    void test() {
      ...
      // => B2.this 문법을 사용하라!
      // 
      System.out.println(B2.this.v2);  // --> this$0.v2 바깥 객체의 v2 --> 자신을 탄생시킨 바깥 객체
      B2.this.m2();
    }
  }
}
...
public class Exam0220 {
  ...
  public static void main(String[] args) {
    ...
    // inner 객체 생성  (항상 바깥 객체가 필요함)
    B2.X inner = outer.new X(); // --> new X(outer)  --> 바깥 클래스 객체 없이 생성 못함
    ...
    B2 outer3 = null;
    // B2.X inner3 = outer3.new X(); null point exception
